        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: <Widget>[
                            ...
                            BlocBuilder<CharacterCreatorCubit,
                              ...
                              builder: (BuildContext context,
                                ...
                                return TextFormField(
                                  ...
                                  onChanged: (String v) =>
                                      _cubit.updateAge(int.tryParse(v) ?? 0),
                                );
                              },
                            ),
                          ],
                        ...
                        BlocBuilder<CharacterCreatorCubit,
                          ...
                          builder: (BuildContext context,
                            ...
                            return TraitsCreator(
                              ...
                              onAdd: (String t) => _cubit.addPositiveTrait(t),
                              onRemove: (String t) =>
                        ...
                        BlocBuilder<CharacterCreatorCubit,
                          ...
                          builder: (BuildContext context,
                            ...
                            return TraitsCreator(
                              ...
                              onAdd: (String t) => _cubit.addNegativeTrait(t),
                              onRemove: (String t) =>
              ...
              // Fixed action row pinned to bottom
              SafeArea(
                top: false,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: <Widget>[
                    // Distinct circular save button
                    Material(
                      elevation: 4,
